...
namespace Madingley
{
    ...
    public class Eating: IEcologicalProcessWithinGridCell
    {
        ...
        /// </summary>
        public Eating(double cellArea, string globalModelTimeStepUnit, double[] cellTemperature)
        {
            ...
            RevisedPredation RevisedPredationImplementation = new RevisedPredation(cellArea, globalModelTimeStepUnit, cellTemperature);
            ...
            switch (NutritionSource)
            {
                case "herbivore":
                    ...
                    if (cellEnvironment["Realm"][0] == 2.0)
                        ...
                        cellEnvironment, currentMonth,
                        madingleyCohortDefinitions, madingleyStockDefinitions);
                    else

                        Implementations["revised herbivory"].GetEatingPotentialTerrestrial
                        (gridCellCohorts, gridCellStocks, actingCohort,
                        cellEnvironment, currentMonth, madingleyCohortDefinitions, madingleyStockDefinitions);
                ...
                case "omnivore":
                    ...
                    if (cellEnvironment["Realm"][0] == 2.0) 
                        Implementations["revised herbivory"].GetEatingPotentialMarine
                        (gridCellCohorts, gridCellStocks, actingCohort,
                        cellEnvironment, currentMonth, madingleyCohortDefinitions,
