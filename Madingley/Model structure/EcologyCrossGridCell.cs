...
namespace Madingley
{
    ...
    public class EcologyCrossGridCell
    {
        ...
        public void UpdateCrossGridCellEcology(ModelGrid madingleyModelGrid, ref uint dispersalCounter, CrossCellProcessTracker trackCrossCellProcesses, uint currentTimeStep, RogierDataCarriers dataobj)
        {
            // Apply the results of cross-cell ecological processes
            ApplyCrossGridCellEcologicalProcessResults.UpdateAllCrossGridCellEcology(madingleyModelGrid, ref dispersalCounter, trackCrossCellProcesses, currentTimeStep, dataobj);
