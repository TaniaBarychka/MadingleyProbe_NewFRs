...
namespace Madingley
{
    ...
    public class EcologyCohort
    {
        ...
        /// </summary>
        public void InitializeEcology(double cellArea, string globalModelTimeStepUnit, double[] cellTemperature, Boolean drawRandomly)
        {
            ...
            Eating EatingFormulation = new Eating(cellArea, globalModelTimeStepUnit, cellTemperature);
