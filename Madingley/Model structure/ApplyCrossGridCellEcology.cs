...
namespace Madingley
{
    ...
    public class ApplyCrossGridCellEcology
    {
        ...
        /// </summary>
        public void UpdateAllCrossGridCellEcology(ModelGrid madingleyModelGrid, ref uint dispersalCounter, CrossCellProcessTracker trackCrossCellProcesses, uint currentTimeStep, RogierDataCarriers dataobj)
        {
            // Rogier edit: collect dispersal before any cohorts are moved but they have been idenified and chosen...
            
            if ((currentTimeStep / 12) >= dataobj.burnintime)
            {
                dataobj.CalculateDispersalData(madingleyModelGrid, currentTimeStep);
            }
